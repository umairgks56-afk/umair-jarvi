...
Dim shell, fso, root, agentDir, pythonExe, apiCmd, voiceCmd, ollamaCheck, apiReady, proc
...
' Avoid starting duplicate API/voice processes if JARVIS is already running.
